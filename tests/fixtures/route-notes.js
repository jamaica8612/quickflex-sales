...
let zones = ['303D','304C','303A'].map((name,i)=>({id:uuid(String(i+4)),company_id:company.id,name,memo:i ? '구역 공통 안내' : '동문 진입 · 배송 팁을 확인해 주세요.',polygon:{type:'Polygon',coordinates:[[[129.05,35.16],[129.06,35.16],[129.06,35.17],[129.05,35.16]]]},created_by:user.id,updated_at:'2026-09-21T10:00:00Z'}));
