...
test("blocking overlays and the DB sheet expose modal semantics and start inert", () => {
  for (const id of ["setupOverlay", "authOverlay", "pendingOverlay", "updateNoticeOverlay", "salesOverrideOverlay", "measurementGuideOverlay"]) {
  ...
  assert.match(main, /return \[el\.updateNoticeOverlay, el\.salesOverrideOverlay, el\.pendingOverlay, el\.authOverlay, el\.setupOverlay, el\.measurementGuideOverlay, el\.profileSignatureOverlay, el\.dbSheet\]/);
