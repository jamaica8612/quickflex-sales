...
export const APP_UPDATE_NOTICE = {
  id: "2026-09-15-measurement-open-v1",
  items: [
    "Android 측정앱을 설치하면 배송한 가구·상품수와 구역을 자동으로 집계할 수 있어요.",
    "업무 종료 때 수량을 확인·수정한 뒤 매출에 반영해 주세요.",
    "아직 베타 기능이라 일부 배송이 누락되거나 구역이 다르게 잡힐 수 있어요.",
  ],
};
