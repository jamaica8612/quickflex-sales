const CACHE_NAME = "quickflex-shell-v1.0.93-usage-guide-1-route-notes-ui-9-market-annexes-pretendard";
const SHELL_FILES = [
  ...
  "./src/lib/route-note-icons.js?v=2",
  ...
  "./src/ui/route-note-zone-editor.js?v=6",
  "./styles/route-note-zone-editor.css?v=2",
  "./styles/route-note-map.css?v=5",
  "./src/lib/route-note-map.js?v=8",
  "./src/services/route-notes.js?v=2",
  "./src/ui/route-notes.js?v=12",
