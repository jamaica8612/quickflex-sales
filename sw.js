const CACHE_NAME = "quickflex-shell-v1.0.96-usage-guide-1-route-notes-ui-9-market-annexes-pretendard";
const SHELL_FILES = [
  ...
  "./src/lib/route-note-map-geometry.js?v=2",
  "./src/lib/route-note-zone-model.js",
  "./src/ui/route-note-zone-editor.js?v=7",
  "./styles/route-note-zone-editor.css?v=2",
  "./styles/route-note-map.css?v=6",
  "./src/lib/route-note-map.js?v=9",
  "./src/services/route-notes.js?v=2",
  "./src/ui/route-notes.js?v=14",
  "./src/services/route-note-share.js",
  "./src/ui/route-note-share.js",
  "./styles/route-notes.css?v=9",
  "./styles/agricultural-market-route-map.css?v=2",
  "./styles/route-note-share.css?v=1",
  "./route-share.html",
  "./route-share.js?v=1.0.96",
  ...
  "./src/lib/revenue.js",
  "./src/lib/format.js",
  "./src/lib/work-date.js?v=1.0.96",
  "./src/lib/measurement-app-launch.js",
  "./manifest.webmanifest?v=1.0.96",
  "./icon-192.png?v=4",
  "./icon-512.png?v=4",
