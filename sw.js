const CACHE_NAME = "quickflex-shell-v1.0.100-usage-guide-1";
const SHELL_FILES = [
  ...
  "./src/lib/revenue.js",
  "./src/lib/format.js",
  "./src/lib/work-date.js?v=1.0.100",
  "./src/lib/measurement-app-launch.js",
  "./manifest.webmanifest?v=1.0.100",
  "./icon-192.png?v=4",
  "./icon-512.png?v=4",
