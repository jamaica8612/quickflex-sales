const CACHE_NAME = "quickflex-shell-v1.0.88-native-session-recovery-1-usage-guide-1-route-notes-3";
const SHELL_FILES = [
  ...
  "./src/lib/route-note-icons.js",
  "./src/lib/route-note-rules.js",
  "./src/lib/route-note-map-geometry.js",
  "./src/lib/route-note-zone-model.js",
  "./src/ui/route-note-zone-editor.js?v=2",
  "./styles/route-note-zone-editor.css?v=1",
  "./styles/route-note-map.css?v=1",
  "./src/lib/route-note-map.js?v=4",
  "./src/services/route-notes.js?v=2",
  "./src/ui/route-notes.js?v=6",
  "./src/services/route-note-share.js",
  "./src/ui/route-note-share.js",
  "./styles/route-notes.css?v=5",
  "./styles/route-note-share.css?v=1",
  "./route-share.html",
  "./route-share.js?v=1.0.88",
