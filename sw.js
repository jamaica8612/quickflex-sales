const CACHE_NAME = "quickflex-shell-v1.0.86-native-session-recovery-1-usage-guide-1-route-notes-3";
const SHELL_FILES = [
  ...
  "./src/ui/route-note-zone-editor.js",
