export function buildSchedulePrompt(ownerName: string, year: number, month: number) {
  return [
    ...
    "3) 425BD는 425B와 425D로 펼칩니다. 한 셀의 모든 구역을 배열에 포함.",
    "4) 명시된 휴무, OFF, '-', 'X'만 null로. 빈 셀이나 읽지 못한 셀은 []로.",
    "5) 영문은 항상 대문자, 공백/특수문자 제거.",
    "6) 표에 없는 날짜는 제외. 숫자 날짜는 전월 26일~당월 25일. 명시된 월/연도나 1일부터 시작하는 전체 달력은 그대로 따르세요.",
    "7) 셀의 글자가 흐리거나 애매하면 추측하지 말고 [].",
    "",
