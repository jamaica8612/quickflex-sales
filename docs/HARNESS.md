...
- Approved drivers can read their own rates plus approved admin-owned rates; admin rates are the shared default route-rate master used when a fixed driver has no personal rate row.
